 ...
 * @author Jeff Dinkins
 */
public class MyInternalFrameDemo extends MyDemoModule {
	 ...
	 */
	public MyInternalFrameDemo(MySwingEntry swingset) {
	...
	class ShowFrameAction extends AbstractAction {
		 ...
		 * @param icon the icon
		 */
		public ShowFrameAction(MyInternalFrameDemo demo, Icon icon) {
			this.demo = demo;
			this.icon = icon;
		}
	...
	class ImageScroller extends JScrollPane {
		 ...
		 */
		public ImageScroller(MyInternalFrameDemo demo, Icon icon, int layer, int count) {
			super();
			JPanel p = new JPanel();
