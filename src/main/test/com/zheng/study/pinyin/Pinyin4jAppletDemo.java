package com.zheng.study.pinyin;
		...
		if (convertButton == null) {
			...
			convertButton.addActionListener(new java.awt.event.ActionListener() {
				...
				private void updateUnformattedTextField(char chineseCharacter) {
					unformattedHanyuPinyinTextArea
							.setText(concatPinyinStringArray(PinyinHelper.toHanyuPinyinStringArray(chineseCharacter)));
					unformattedTongyongPinyinTextArea.setText(
							concatPinyinStringArray(PinyinHelper.toTongyongPinyinStringArray(chineseCharacter)));
					unformattedWadePinyinTextArea.setText(
							concatPinyinStringArray(PinyinHelper.toWadeGilesPinyinStringArray(chineseCharacter)));
					unformattedMPS2PinyinTextArea
							.setText(concatPinyinStringArray(PinyinHelper.toMPS2PinyinStringArray(chineseCharacter)));
					unformattedYalePinyinTextArea
							.setText(concatPinyinStringArray(PinyinHelper.toYalePinyinStringArray(chineseCharacter)));
					unformattedGwoyeuRomatzyhTextArea.setText(
							concatPinyinStringArray(PinyinHelper.toGwoyeuRomatzyhStringArray(chineseCharacter)));
				}
		...
		if (toneTypesComboBox == null) {
			...
			toneTypesComboBox.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (toneTypesComboBox.getSelectedItem() instanceof String 
							&&toneTypes.length>2&&toneTypes[2] .equals(toneTypesComboBox.getSelectedItem())) {
